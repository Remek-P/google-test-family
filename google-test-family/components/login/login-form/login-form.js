      ...
      <form className={classes.loginForm} name="login" id="form" onSubmit={handleClick}>
        ...
        <div className={classes.loginFormContainerAction}>
          ...
          <div className={classes.inputContainerOther}>
            ...
            <MyLink where="https://support.google.com/accounts/answer/2917834?visit_id=638499894514079638-819687517&p=signin_privatebrowsing&hl=en-GB&rd=1"
                    linkClass="regular"
            >Dowiedz się więcej o używaniu trybu gościa</MyLink>
          </div>
